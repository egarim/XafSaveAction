...
namespace XafSaveAction.Blazor.Server {
    public partial class XafSaveActionBlazorApplication : BlazorApplication {
        public XafSaveActionBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafSaveActionBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
